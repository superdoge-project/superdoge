...
In order to support loading of multiple wallets in superdoge-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is superdoge.cpp.
...
Changes to superdoge.cpp
----------------------
superdoge.cpp is the entry point into superdoge-qt, and as such, will require some minor modifications to provide hooks for
