...
* WebSocket: [https://github.com/SUPERDOGE-Core/insight-api-superdoge#web-socket-api](https://github.com/SUPERDOGE-Core/insight-api-superdoge#web-socket-api)
* API: [https://github.com/SUPERDOGE-Core/insight-api-superdoge#swifttx-transactions](https://github.com/SUPERDOGE-Core/insight-api-superdoge#swifttx-transactions)
...
By default, the SUPERDOGE Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SUPERDOGE Core daemon:
