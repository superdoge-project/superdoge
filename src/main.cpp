...
#if defined(NDEBUG)
#error "SUPERDOGE cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in usuperdoge) are considered zero fee (for relaying and mining)
...
{
    RenameThread("superdoge-scriptch");
