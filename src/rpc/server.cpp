...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop SUPERDOGE server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "SUPERDOGE server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SUPERDOGE features */
        {"superdoge", "listmasternodes", &listmasternodes, true, true, false},
        {"superdoge", "getmasternodecount", &getmasternodecount, true, true, false},
        {"superdoge", "masternodeconnect", &masternodeconnect, true, true, false},
        {"superdoge", "masternodecurrent", &masternodecurrent, true, true, false},
        {"superdoge", "masternodedebug", &masternodedebug, true, true, false},
        {"superdoge", "startmasternode", &startmasternode, true, true, false},
        {"superdoge", "createmasternodekey", &createmasternodekey, true, true, false},
        {"superdoge", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"superdoge", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"superdoge", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"superdoge", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"superdoge", "getmasternodescores", &getmasternodescores, true, true, false},
        {"superdoge", "mnsync", &mnsync, true, true, false},
        {"superdoge", "spork", &spork, true, true, false},
        {"superdoge", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use superdoged, or the -server option to superdoge-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> superdoge-cli " + methodname + " " + args + "\n";
}
