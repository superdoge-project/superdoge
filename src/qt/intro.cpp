...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SUPERDOGE Core"),
     ...
     * override -datadir in the superdoge.conf file in the default data directory
     * (to be consistent with superdoged behavior)
     */
    if (dataDir != getDefaultDataDirectory())
