...
/** Utility functions used by the SUPERDOGE Qt UI.
 */
namespace GUIUtil
{
...
// Render SUPERDOGE addresses in monospace font
...
// Parse "superdoge:" URI into recipient object, return true on successful parsing
