...
QFontDatabase::addApplicationFont(":/fonts/superdoge_font");

QString windowTitle = tr("SUPERDOGE Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SUPERDOGE address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and SUPERDOGE: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SUPERDOGE Wallet"), this);
    aboutAction->setStatusTip(tr("Show information about SUPERDOGE Wallet"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SUPERDOGE Wallet"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SUPERDOGE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SUPERDOGE addresses"));
    ...
    openAction->setStatusTip(tr("Open a SUPERDOGE: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the SUPERDOGE Wallet help message to get a list with possible SUPERDOGE command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SUPERDOGE Wallet client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SUPERDOGE network", "", count));
}
...
{
    QString strTitle = tr("SUPERDOGE Wallet"); // default title
