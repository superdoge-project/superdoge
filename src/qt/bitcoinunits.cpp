...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(SDOGE);
   // unitlist.append(mSUPERDOGE);
   // unitlist.append(uSUPERDOGE);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case SDOGE:
        return QString("sdoge");
    case mSDOGE:
        return QString("msdoge");
    case uSDOGE:
        return QString::fromUtf8("usdoge");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case mSDOGE:
            return QString("mSDOGE");
        case uSDOGE:
            return QString::fromUtf8("μSDOGE");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case SDOGE:
            return QString("tSDOGE");
        case mSDOGE:
            return QString("mSDOGE");
        case uSDOGE:
            return QString::fromUtf8("μtSDOGE");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case SDOGE:
            return QString("SDOGE");
        case mSDOGE:
            return QString("Milli-SDOGE (1 / 1" THIN_SP_UTF8 "000)");
        case uSDOGE:
            return QString("Micro-SDOGE (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case SDOGE:
            return QString("TestSDOGEs");
        case mSDOGE:
            return QString("Milli-TestSDOGEs (1 / 1" THIN_SP_UTF8 "000)");
        case uSDOGE:
            return QString("Micro-TestSDOGEs (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
