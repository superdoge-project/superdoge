...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SUPERDOGE Core superdoge-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  superdoge-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded SUPERDOGE transaction") + "\n" +
                               "  superdoge-tx [options] -create [commands]   " + _("Create hex-encoded SUPERDOGE transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded SUPERDOGE transaction
