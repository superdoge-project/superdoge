...
#   c) node1 mines 32 blocks, so now node 0 has 60001superdoge, node 1 has 4250superdoge, node2 has none.
#   d) node0 sends 601 superdoge to node2, in two transactions (301 superdoge, then 300 superdoge).
