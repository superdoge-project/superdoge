Contributing to SUPERDOGE Core
============================

The SUPERDOGE Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SUPERDOGE Core project, and is not to be
confused with overall SUPERDOGE Network Protocol consensus changes.

Whether a pull request is merged into SUPERDOGE Core rests with the project merge
...
Patches that change SUPERDOGE consensus rules are considerably more involved than
...
Where a patch set proposes to change the SUPERDOGE consensus, it must have been
...
The project leader is the release manager for each SUPERDOGE Core release.
